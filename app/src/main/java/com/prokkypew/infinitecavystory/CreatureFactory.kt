...
class CreatureFactory(private val world: World) {
    fun newPlayer(messages: ArrayList<String>, fov: FieldOfView): Creature {
        val player = Creature(world, '@', Color.WHITE, getString(R.string.player), getIntResource(R.integer.player_hp), getIntResource(R.integer.player_mana))
    ...
    fun newFungus(depth: Int): Creature {
        val fungus = Creature(world, 'f', Color.GREEN, getString(R.string.fungus), getIntResource(R.integer.fungus_hp), getIntResource(R.integer.fungus_mana))
    ...
    fun newBat(depth: Int): Creature {
        val bat = Creature(world, 'b', Color.YELLOW, getString(R.string.bat), getIntResource(R.integer.bat_hp), getIntResource(R.integer.bat_mana))
        bat.ai = BatAi(bat)
